...
import ejercicio4_adaptadopaEntender.GraphTraversalTool;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		Node n1 = new Node(10);	n1.setColor("red");
		Node n2 = new Node(5);
		Node n3 = new Node(7);	n3.setColor("red");
		Node n4 = new Node(2);
		Node n5 = new Node(12);
		Node n6 = new Node(1);	n6.setColor("red");
		Node n7 = new Node(9);
		...
		g1.connectNodes(n4, n7); //2 -> 9
		g1.connectNodes(n7, n2); //9 -> 5
		...
		EncontrarCamino lc = new EncontrarCamino();
		...
		System.out.println(lc.bucarCamino(g1, n4, n2));
